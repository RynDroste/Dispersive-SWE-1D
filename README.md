...
- Initialize `hbar = terrain + h`, `qbar = q`, and at cell edges $x+1/2$ 
- Average `alpha_hbar` over neighboring edges to obtain `alpha_qbar`, co-located with `qbar` (at cell centers).
